...
function showErrMsgUrl(msg, url) {
    layer.msg(msg, { icon: 5, time: 3000, shade: 0.5, shadeClose: true }, function () {
        location.href = url;
    });
}
...
function showOkAndRefresh(msg) {
    layer.msg(msg, { icon: 1, time: 3000, shade: 0.5, shadeClose: true }, function () {
